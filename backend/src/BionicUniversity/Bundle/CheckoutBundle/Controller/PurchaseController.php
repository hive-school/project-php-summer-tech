...
use BionicUniversity\Bundle\CheckoutBundle\Form\PurchaseType;
...
class PurchaseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BionicUniversityCheckoutBundle:Purchase')->findAll();
     ...
     * @Method("POST")
     * @Template("BionicUniversityCheckoutBundle:Purchase:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BionicUniversityCheckoutBundle:Purchase')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BionicUniversityCheckoutBundle:Purchase:edit.html.twig")
     */
